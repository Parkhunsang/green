					...
					<a href="/coomarket/client/detailGoods.hun?np_no=${product.np_no}">
						<div class="goods_list_image_text_wrap">
							...
							<div class="goods_list_text_wrap">
								<p class="goods_title">${product.np_name}</p>
								<p class="span_wrap">${product.np_discount}%
									<span style="text-decoration: line-through; color:#888;">${product.np_price}</span>
								</p>
								<p class="goods_total_price"><fmt:formatNumber value="${product.np_price - product.np_price*product.np_discount / 100}"></fmt:formatNumber></p>
							</div>
						</div>
					</a>
					</li>
